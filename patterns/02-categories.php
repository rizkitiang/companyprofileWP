 ...
 * Slug: webstein-rizki/post-categories
...
<div class="wp-block-group pattern-categories" style="padding-bottom:var(--wp--preset--spacing--large)"><!-- wp:heading -->
    <h2><?php esc_html_e('Post Categories ', 'webstein-rizki') ?></h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-columns"><!-- wp:column {"style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"},"blockGap":"0px"}}} -->
        <div class="wp-block-column" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:image {"id":2262,"sizeSlug":"full","linkDestination":"custom"} -->
            <figure class="wp-block-image size-full"><a href="#"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/internal.png" alt="" class="wp-image-2262" /></a></figure>
            <!-- /wp:image -->
            ...
            <div class="wp-block-group has-base-background-color has-background" style="padding-right:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:heading {"level":3,"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-primary"}}}}} -->
                <h3 class="has-link-color"><a href="#"><?php esc_html_e('Outdoors', 'webstein-rizki') ?></a></h3>
                <!-- /wp:heading -->
            </div>
            <!-- /wp:group -->
        </div>
        ...
        <div class="wp-block-column"><!-- wp:image {"id":2265,"sizeSlug":"full","linkDestination":"custom"} -->
            <figure class="wp-block-image size-full"><a href="#"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/internal02.png" alt="" class="wp-image-2265" /></a></figure>
            <!-- /wp:image -->

            <!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|x-small","left":"var:preset|spacing|x-small"}}},"backgroundColor":"base","layout":{"type":"constrained"}} -->
            <div class="wp-block-group has-base-background-color has-background" style="padding-right:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:heading {"level":3,"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-primary"}}}}} -->
                <h3 class="has-link-color"><a href="#"><?php esc_html_e('Mountains', 'webstein-rizki') ?></a></h3>
                <!-- /wp:heading -->
            </div>
            <!-- /wp:group -->
        </div>
        ...
        <div class="wp-block-column"><!-- wp:image {"id":2263,"sizeSlug":"full","linkDestination":"custom"} -->
            <figure class="wp-block-image size-full"><a href="#"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/internal03.png" alt="" class="wp-image-2263" /></a></figure>
            <!-- /wp:image -->

            <!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|x-small","left":"var:preset|spacing|x-small"}}},"backgroundColor":"base","layout":{"type":"constrained"}} -->
            <div class="wp-block-group has-base-background-color has-background" style="padding-right:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:heading {"level":3,"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-primary"}}}}} -->
                <h3 class="has-link-color"><a href="#"><?php esc_html_e('Guides', 'webstein-rizki') ?></a></h3>
                <!-- /wp:heading -->
            </div>
            <!-- /wp:group -->
        </div>
